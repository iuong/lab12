...
>>>>>>> a8cb1002ae1ab0067790f2cc475b0a5446b65180
		...
		ArrayList<TreeNode> collectAncestorsToList() {
			...
			// HINT: going up the nodes of a tree is like traversing a linked list.
			// If that isn’t clear, draw a tree, mark any leaf node, and then mark its
			// ancestors
			// in order from recent to ancient.
			// Expect a question about this on the final exam.
			TreeNode curr = this;
	...
	private void addLine(String line) throws TreeException
	{
			...
			if (colonIndex < 0) throw new TreeException("Colon cannot be found in" + line);
	...
	TreeNode getMostRecentCommonAncestor(String name1, String name2) throws TreeException
	{
		...
		if (node1 == null) throw new TreeException("Node name of " + name1 + "is missing");
		TreeNode node2 = root.getNodeWithName(name2);		// node whose name is name2
		if (node2 == null) throw new TreeException("Node name of " + name2 + "is missing");
